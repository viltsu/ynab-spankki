...
class MainModuleInjector extends import0.NgModuleInjector<import1.MainModule> {
  ...
  constructor(parent:import20.Injector) {
    super(parent,[import21.HelloWorldComponentNgFactory],[import21.HelloWorldComponentNgFactory]);
  }
  ...
  get _APP_ID_14():any {
    if ((this.__APP_ID_14 == (null as any))) { (this.__APP_ID_14 = import22._appIdRandomProviderFactory()); }
  ...
  get _EventManager_18():import13.EventManager {
    if ((this.__EventManager_18 == (null as any))) { (this.__EventManager_18 = new import13.EventManager(this._EVENT_MANAGER_PLUGINS_17,this.parent.get(import25.NgZone))); }
  ...
  get _RootRenderer_22():any {
    if ((this.__RootRenderer_22 == (null as any))) { (this.__RootRenderer_22 = import26._createConditionalRootRenderer(this._DomRootRenderer_21,this.parent.get(import26.NgProbeToken,(null as any)))); }
  ...
  get _RadioControlRegistry_30():import19.RadioControlRegistry {
    if ((this.__RadioControlRegistry_30 == (null as any))) { (this.__RadioControlRegistry_30 = new import19.RadioControlRegistry()); }
  ...
  createInternal():import1.MainModule {
    ...
    this._Testability_10 = new import9.Testability(this.parent.get(import25.NgZone));
    this._ApplicationRef__11 = new import10.ApplicationRef_(this.parent.get(import25.NgZone),this.parent.get(import27.Console),this,this._ErrorHandler_8,this,this._ApplicationInitStatus_9,this.parent.get(import9.TestabilityRegistry,(null as any)),this._Testability_10);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import28.LOCALE_ID)) { return this._LOCALE_ID_6; }
    ...
    if ((token === import22.APP_ID)) { return this._APP_ID_14; }
